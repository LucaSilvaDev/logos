  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:serif;max-width:480px;margin:0 auto;color:#1a1a1a">
        <h2 style="font-weight:400;font-size:14px;color:#777b86">Selah</h2>
        <h1 style="font-weight:400;font-size:22px">Redefinição de senha</h1>
        <p style="color:#444;line-height:1.6">
          Recebemos uma solicitação para redefinir a senha da sua conta.<br>
          Clique no link abaixo para criar uma nova senha:
        </p>
        <a href="${link}" style="display:inline-block;margin:16px 0;padding:12px 24px;background:#17191c;color:#fff;text-decoration:none;font-size:14px;border-radius:9999px">
          Redefinir senha
        </a>
